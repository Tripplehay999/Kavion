...
export default async function ProjectsPage({
  ...
  const [projects, { connected: githubConnected }, params] = await Promise.all([
    getProjects(),
    getGithubStatus(),
    searchParams,
  ])
    ...
    <div className="page-scroll">
      ...
      <ProjectsClient
        initialProjects={projects as {
          ...
          progress: number; stack: string[]; color: string; github_repo?: string | null; updated_at: string
        }[]}
        isLive={live}
        githubConnected={githubConnected}
        autoOpenGithub={params.github === 'connected'}
      />
